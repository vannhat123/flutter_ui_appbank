      ...
      children: [
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    const Text('Your total expences',style: TextStyle(color: Colors.white54,fontSize: 25),),
                    const SizedBox(height: 10,),
                    const Text('\$1063.30',style: TextStyle(color: Colors.white, fontSize: 30,fontWeight: FontWeight.bold),),
                  ],
                ),
              ]
          ),
        ...
        Column(
          children:  [
            ...
            const Text('Track your expenses', style: TextStyle(fontSize: 25,fontWeight: FontWeight.bold),),
            const SizedBox(height: 35,),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children:  [
                ContainerInformation(textName: 'Travel',textPrice: '\$399',colorFont: Colors.pink,),
                const SizedBox(width: 10,),
                ContainerInformation(textName: 'Shopping',textPrice: '\$375',colorFont: Colors.amber,),
              ],
            ),
            const SizedBox(height: 10,),
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children:  [
                ContainerInformation(textName: 'Sport',textPrice: '\$199.80',colorFont: Colors.cyan,),
                const SizedBox(width: 10,),
                ContainerInformation(textName: 'Medicine',textPrice: '\$89.8',colorFont: Colors.deepPurple,),
              ],
            ),
            const SizedBox(height: 10,),
            Container(
              ...
              child: Row(
                children: const [
                  Text('Credit Card\n repayment',style: TextStyle(fontSize: 22,color: Colors.white),),
                  Spacer(),
...
class ContainerInformation extends StatelessWidget{
  ...
  ContainerInformation({this.colorFont,this.textPrice,this.textName,Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return  Container(
      ...
      child: Column(
        ...
        children:  [
          Text(textName!,style: TextStyle(fontSize: 18,color:  colorFont), ),
          Text(textPrice!,style:TextStyle(fontSize: sizeFont,color: colorFont,fontWeight: FontWeight.bold) ,),
        ],
      ),
    );
  }
